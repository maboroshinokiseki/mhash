...
fn main() {
    ...
    generate_complete(&mut cmd, &out_dir, "mhash.bash", clap_complete::Shell::Bash);
    generate_complete(&mut cmd, &out_dir, "mhash.zsh", clap_complete::Shell::Zsh);
    generate_complete(&mut cmd, &out_dir, "mhash.fish", clap_complete::Shell::Fish);
}
